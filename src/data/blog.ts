...
export const blogPosts: BlogPost[] = [
    {
        ...
        excerpt: 'Exploring best practices for building robust and scalable web applications using Laravel framework.',
        content: `
...
Laravel provides excellent tools for building maintainable and scalable applications when used correctly.
    ...
    },
    {
        ...
        excerpt: 'Discover how FastAPI is revolutionizing Python web development with its modern approach.',
        content: `
...
FastAPI makes it incredibly easy to build robust APIs with minimal boilerplate code.
    ...
    },
    {
        ...
        excerpt: 'Learn how to leverage .NET Core for building enterprise-grade applications with best practices.',
        content: `
...
.NET Core provides everything needed for enterprise applications while maintaining high performance.
    ...
    },
    {
        ...
        excerpt: 'Explore the power of Next.js combined with TypeScript for creating type-safe, performant web applications.',
        content: `
