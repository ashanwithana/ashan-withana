...
const ProjectsPage: NextPage<ProjectsPageProps> = ({ repos, error }) => {
    ...
    const inputFocusBoxShadow = useColorModeValue('0 0 0 1px #3182ce', '0 0 0 1px #90cdf4')
    ...
    if (error) {
        return (
            <MainLayout>
                <NextSeo title="Projects" description="Error loading projects from GitHub" />
            ...
            >
                <VStack spacing="6" color="white" maxW="4xl">
                    ...
                    <HStack spacing="8" pt="4">
                        <VStack spacing="1">
                            <Text fontSize="2xl" fontWeight="bold">{stats.totalRepos}</Text>
                            <Text fontSize="sm" opacity="0.8">Repositories</Text>
                        </VStack>
                        <VStack spacing="1">
                            <Text fontSize="2xl" fontWeight="bold">{stats.totalStars}</Text>
                            <Text fontSize="sm" opacity="0.8">Stars</Text>
                        </VStack>
                        <VStack spacing="1">
                            <Text fontSize="2xl" fontWeight="bold">{stats.languageCount}</Text>
                            <Text fontSize="sm" opacity="0.8">Languages</Text>
                        </VStack>
                        <VStack spacing="1">
                            <Text fontSize="2xl" fontWeight="bold">{stats.totalForks}</Text>
                            <Text fontSize="sm" opacity="0.8">Forks</Text>
                        </VStack>
                    </HStack>
                </VStack>
            </MotionFlex>
                    ...
                    >
                        ...
                        <InputGroup w="full">
                            ...
                            <Input
                                ...
                                _focus={{ borderColor: inputFocusBorderColor, boxShadow: inputFocusBoxShadow }}
                            />
                        </InputGroup>
