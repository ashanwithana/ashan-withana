            ...
            <CardBody p={0}>
                <VStack spacing={{ base: 4, lg: 3 }} align="stretch" height="full">
                    <VStack spacing={3} align="center" textAlign="center">
                        ...
                        <Heading
                            size={{ base: "lg", lg: "md" }}
                            color={service.popular ? 'purple.600' : useColorModeValue('gray.800', 'white')}
                            fontWeight="bold"
                            lineHeight="short"
                        >
                            {service.title}
...
export const Services: React.FC = () => {
    ...
    return (
        <Box as="section" py={{ base: 8, md: 12 }} minH="100vh" display="flex" alignItems="center">
            <Container maxW="7xl">
                <VStack spacing={{ base: 8, md: 12 }} align="stretch">
                    ...
                    <VStack spacing={6} textAlign="center" py={8}>
                        ...
                        <Text
                            ...
                            lineHeight="tall"
                        >
                            Transform your ideas into robust, scalable solutions with my comprehensive development services.
                            From backend architecture to full-stack applications, I deliver quality code that drives results.
                        </Text>
                    </VStack>
                    ...
                    <VStack
                        ...
                        textAlign="center"
                    >
                        <Heading size={{ base: "md", md: "lg" }}>Ready to Start Your Project?</Heading>
                        <Text color="gray.600" maxW="md" fontSize={{ base: "sm", md: "md" }}>
                            Let's discuss your requirements and create something amazing together.
                            I'm here to help you build robust, scalable solutions.
                        </Text>
